...
from s3_data import get_df_s3_data_all_accounts_from_accounts_combined_results
...
class S3DataAnalyzer:
    ...
    def _get_df_s3_data_analyzed(self) -> Df:
        ...
        all_accounts_s3_data_df = get_df_s3_data_all_accounts_from_accounts_combined_results()
